...
void ReEnlist_xa(ITransactionEnlistmentAsync * pTransactionEnlistmentAsync, IResourceManager * pIResourceManager, XACTSTAT * pTransactionOutput)
{
    	//*******************
...
int testDtc_E2E_xa_DoublePipe()
{
    ...
    if (committing && transactionResourceAsync.m_donotCommit)
	{
		...
		ReEnlist_xa(pTransactionEnlistmentAsync, pIResourceManager, pTransactionOutput);

		XACTSTAT transactionOutput2;				
		XACTSTAT * pTransactionOutput2 = &transactionOutput2;		
		ReEnlist_xa(pTransactionEnlistmentAsync, pIResourceManager, pTransactionOutput2);
