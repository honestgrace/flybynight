...
#endif // _WIN64
	LK_DFLT_INITSIZE = LK_SMALL_TABLESIZE, // Default initial size of hash table
...
# define LKRHASH_ALLOCATOR_NEW(C, N)                            \
    ...
    C::sm_palloc = new ALLOC_CACHE_HANDLER("LKRhash:" #C, &acc, false);
...
namespace LKRhash {
	...
	private:
		...
		//
#if defined(LKRHASH_ALLOCATOR_NEW) && (!defined(_PREFAST_))
		friend bool LKRHashTableInit();
		friend void LKRHashTableUninit();
#endif // LKRHASH_ALLOCATOR_NEW
